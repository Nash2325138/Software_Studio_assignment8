...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void jumpToIPinputLayout() {
        setContentView(R.layout.ip_input_page);
        ipInput = (EditText) findViewById(R.id.ipText);
        ipSend = (Button) findViewById(R.id.ip_send);

        ipSend.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                serverIP = new String(ipInput.getText().toString());
                jumpToMainLayout();
            }
        });
    }
    ...
    public void jumpToResultLayout(String resultStr){
        ...
        if (textResult != null) {
            ...
            ResultSendThread thread = new ResultSendThread(resultStr);
            thread.start();
        }
    ...
    class ResultSendThread extends Thread {
        private String toSend;
        public ResultSendThread(String toSend) {
            this.toSend = toSend;
        }
        @Override
        public void run() {
